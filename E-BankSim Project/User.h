...
class clsUser : public clsPerson
{
	...
	enum enMode {EmptyMode = 0 , UpdateMod = 1 , AddNewMode = 2};
	enMode _Mode;
	string _UserName;
	string _Password;
	int _Permissons;
	...
	static string _ConvertUserObjectToLine(clsUser User, string Seperator = "#//#")
	{
		...
		UserRecord += to_string(User._Permissons);
...
public:
	...
	enum enPermission{ eAll = -1, pListClients = 1 , pAddNewClient = 2
		, pDeleteClient = 4 , pUpdateClients =8, pFindClient = 16,
		pTranactions = 32 ,pLoginRegister =64 ,
		pManageUsers = 128 , eCurrencyExhange = 256};
